...
The UI is divided in two parts. On the left side, there is a simple interface to select one of the SummarizedExperiment data contained in the dataset.The right part is dedicated to the display of data. The selection of the plot to show
