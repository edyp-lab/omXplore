...
The list of buil-in plots can be obtained with:
...
Most of these functions analyses the data contained in an Experiment of the dataset (an instance of the class `SummarizedExperiment`). For a sake of simplicity, they all have the same two parameters: the dataset in any (compatible) format (See the help page of the plot functions for details) and the indice of the assay to analyse (See [MultiAssayExperiment](https://www.bioconductor.org/packages/release/bioc/html/MultiAssayExperiment.html)). 
